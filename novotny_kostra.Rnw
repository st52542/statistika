...
\caption{Histogram měny s maximální hodnotou šikomosti}
\end{figure}
\begin{figure}[H]
\centering
...
\caption{Histogram měny s minimální hodnotou šikomosti}
\end{figure}
\subsection{Boxplot}
...
\caption{Bodový graf měny s maximální hodnotou šikomosti}
\end{figure}
\begin{figure}[H]
\centering
...
\caption{Bodový graf měny s minimální hodnotou šikomosti}
\end{figure}
\subsection{Hexbin}
...
\caption{Hexbin graf měny s maximální hodnotou šikomosti}
\centering
...
\caption{Hexbin graf měny s minimální hodnotou šikomosti}
\end{figure}
\subsection{3D graf}
...
\caption{3D graf graf měny s maximální hodnotou šikomosti}
\end{figure}
\begin{figure}[H]
\centering
...
\caption{3D graf graf měny s minimální hodnotou šikomosti}
\end{figure}
